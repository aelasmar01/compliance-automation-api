"""check users table wiring

Revision ID: 8b5c5a53f9b1
Revises: 2241d526379a
Create Date: 2025-10-29 23:45:14.989239
...
revision: str = '8b5c5a53f9b1'
down_revision: Union[str, Sequence[str], None] = '2241d526379a'
...
def downgrade() -> None:
    ...
    op.create_index(op.f('ix_policies_name'), 'policies', ['name'], unique=1)
